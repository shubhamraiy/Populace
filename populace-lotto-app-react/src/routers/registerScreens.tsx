...
export function registerScreens() {
  ...
  Navigation.registerComponent(screenName.SweepPickNumber, () => SweepPickNumber);
  Navigation.registerComponent(screenName.SweepTableNumber, () => SweepTableNumber);
  Navigation.registerComponent(screenName.PopUpSubmitNumber, () => PopUpSubmitNumber);
  Navigation.registerComponent(screenName.TermsPrivacyTab, () => TermsPrivacyTab);
  Navigation.registerComponent(screenName.PopUpCancelPlan, () => PopUpCancelPlan);
  Navigation.registerComponent(screenName.RequestWithdraw, () => RequestWithdraw);
  Navigation.registerComponent(screenName.ModePickingNumber, () => ModePickingNumber);
  ...
  Navigation.registerComponent(screenName.FinancialServices, () => FinancialServices);
  Navigation.registerComponent(screenName.InsuranceServices, () => InsuranceServices);
}
