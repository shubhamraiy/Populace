...
const TermsCondition: React.FC<Props> = props => {
  ...
  return (
    <Text
      ...
      <Text
        onPress={() =>
          Navigator.setPush(props.componentId, screenName.TermsPrivacyTab, { isTerms: true })
        }
      ...
      <Text
        onPress={() =>
          Navigator.setPush(props.componentId, screenName.TermsPrivacyTab, { isTerms: false })
        }
        style={styles.tvTermsCondition}>
        Privacy Policy
      </Text>
