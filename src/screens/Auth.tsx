  ...
  return (
    <MySafeArea
      ...
      <ScrollView
        ...
        <Text
          //  onPress={() => Navigator.setPush(props.componentId, screenName.Paypal)}
          style={styles.tvSignUpTitle}>
          {'"Sign up below or click below\nto see how it works"'}
        </Text>
        <CustomButton
          title={'Sign Up'}
          marginTop={Utils.calculateHeight(Platform.OS === 'ios' ? 140 : 100)}
          onPress={() =>
        ...
        <CustomButton
          ...
          onPress={() =>
            Navigator.setPush(props.componentId, screenName.SignIn)
          }
        />
      </ScrollView>
